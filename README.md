...
This repository contains a hardened, honest workshop-only robotics paper draft for `counterfactual_affordance_maps`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/93.pdf`
