...
\usepackage{url}
\usepackage{booktabs}
\title{Counterfactual Affordance Maps: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about robot affordance learning. The original research bet was: Map affordances that would exist under alternate grasps, poses, and supports. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item GAT-Grasp: Gesture-Driven Affordance Transfer for Task-Aware Robotic Grasping (2025)
\item SENT Map -- Semantically Enhanced Topological Maps with Foundation Models (2025)
\item GAP-RL: Grasps As Points for RL Towards Dynamic Object Grasping (2024)
\item Affordance-Based Grasping Point Detection Using Graph Convolutional Networks for Industrial Bin-Picking Applications (2021)
\item Non-Standard Map Robot Path Planning Approach Based on Ant Colony Algorithms (2023)
\end{itemize}
