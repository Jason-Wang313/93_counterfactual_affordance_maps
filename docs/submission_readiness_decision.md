...
Honest strongest claim: `Map affordances that would exist under alternate grasps, poses, and supports.` is a plausible branch-structured mechanism for robot affordance learning, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
